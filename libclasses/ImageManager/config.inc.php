...
*/
$IMConfig['base_dir'] = XOOPS_ROOT_PATH.'/modules/kshop/images/products';
...
*/
$IMConfig['base_url'] = XOOPS_URL.'/modules/kshop/images/products';
...
*/
define('IMAGE_CLASS', $moduleConfig['thumblib']);
...
*/
$imagepath=XOOPS_ROOT_PATH . $moduleConfig['thumblibpath'];
define('IMAGE_TRANSFORM_LIB_PATH', $imagepath);
...
*/
$IMConfig['thumbnail_width'] = $moduleConfig['thumbw'];
$IMConfig['thumbnail_height'] = $moduleConfig['thumbw'];
